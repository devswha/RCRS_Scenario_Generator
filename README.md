...
2. Write the configuration file and choose whether use [Feature-Hightlight data augmentation](https://devswha.github.io/RCRS_Scenario_Generator/augmentation/) or not.
...
FH_DATA_AUG: Whether to create the scenario using [Feature-Hightlight data augmentation](https://devswha.github.io/RCRS_Scenario_Generator/augmentation/)
